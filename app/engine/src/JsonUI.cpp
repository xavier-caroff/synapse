...
JSON_SERIALIZE_ENUM(synapse::app::engine::IUserInterface::Severity, {
	{  synapse::app::engine::IUserInterface::Severity::debug,   "debug"},
	{   synapse::app::engine::IUserInterface::Severity::info,    "info"},
	{synapse::app::engine::IUserInterface::Severity::warning, "warning"},
	{  synapse::app::engine::IUserInterface::Severity::error,   "error"},
});
// clang-format on
